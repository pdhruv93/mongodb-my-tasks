...
class AccessToken {
    ...
    info(accessToken) {
        ...
        return _asyncToGenerator(function* () {
            let response = yield _this.request.get(`/auth/realms/${_this.config.realm}/protocol/openid-connect/userinfo`, {
                headers: {
    ...
    get() {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (!_this2.data) {
                let response = yield _this2.request.post(`/auth/realms/${cfg.realm}/protocol/openid-connect/token`, qs.stringify({
                    grant_type: 'password',
